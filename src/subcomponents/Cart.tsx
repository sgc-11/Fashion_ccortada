...
const Cart: React.FC<CartProps> = ({ isOpen, setIsOpen, cart, removeFromCart }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-end">
      <div className="bg-gray-800 h-full w-full max-w-md p-6 overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-2xl font-bold text-pink-500">Your Cart</h3>
        ...
        {cart.length === 0 ? (
          ...
          <>
            ...
            <div className="mt-6">
              <p className="text-xl font-bold text-pink-500">Total: ${total.toFixed(2)}</p>
